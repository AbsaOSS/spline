...
import za.co.absa.spline.core.storage.ExecutionStorage
...
/**
  * The class represents Mongo persistence layer for the [[za.co.absa.spline.core.model.Execution Execution]] entity.
  */
class MongoExecutionStorage(dbUrl: String, dbName: String) extends ExecutionStorage {
