...
/**
  ...
  *
  * @param exprType              see [[za.co.absa.spline.core.model.Expression#exprType Expression.exprType]]
  * @param textualRepresentation see [[za.co.absa.spline.core.model.Expression#textualRepresentation Expression.textualRepresentation]]
  * @param dataType              see [[za.co.absa.spline.core.model.Expression#dataType Expression.dataType]]
  * @param children              see [[za.co.absa.spline.core.model.Expression#children Expression.children]]
  */
...
/**
  * A companion object for the case class [[za.co.absa.spline.core.model.AttributeRemoval AttributeRemoval]].
  */
object AttributeRemoval {

  /**
    * The method constructs new instance of the case class [[za.co.absa.spline.core.model.AttributeRemoval AttributeRemoval]].
    *
    * @param attribute A reference to an attribute that will be removed.
    * @return An instance of the case class [[za.co.absa.spline.core.model.AttributeRemoval AttributeRemoval]].
    */
...
/**
  * A companion object for the case class [[za.co.absa.spline.core.model.AttributeReference AttributeReference]].
  */
object AttributeReference {

  /**
    * The method constructs an instance of the case class [[za.co.absa.spline.core.model.AttributeReference AttributeReference]].
    *
    * @param attributeId   see [[za.co.absa.spline.core.model.AttributeReference#attributeId AttributeReference.attributeId]]
    * @param attributeName see [[za.co.absa.spline.core.model.AttributeReference#attributeName AttributeReference.attributeName]]
    * @param dataType      see [[za.co.absa.spline.core.model.Expression#dataType Expression.dataType]]
    * @return An instance of the case class [[za.co.absa.spline.core.model.AttributeReference AttributeReference]].
    */
