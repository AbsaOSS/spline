...
//    tested: ExecutionPlan): Unit = {
//
//    tested.operations shouldNot be(null)
//    val l = tested.operations.reads.length + tested.operations.others.length + 1
//    l shouldEqual expectedOperations.length
//
...
//    val sut = new DataLineageBuilderFactory(spark.sparkContext.hadoopConfiguration)
//
//    val result = sut.createBuilder(df.queryExecution.analyzed, None, spark.sparkContext).buildExecutionPlan()
//
