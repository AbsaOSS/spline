...
class OperationDetailsControllerTest extends AsyncFunSuite with MockitoSugar with Matchers {
  ...
  val dataTypes = Array[DataType](
    model.SimpleDataType("602147fa-7148-46a7-9978-ba9f63f6b616", true, "string"),
    model.SimpleDataType("89348e28-5621-4ce1-b705-c1301b4d35a7", true, "decimal(28,8)"),
    model.SimpleDataType("951f2d88-f8b4-4bc8-b5bf-524811c9197a", true, "date"),
    model.SimpleDataType("3f6ce2cf-8afa-4a8f-a844-0d0dccbc7ce6", true, "long"),
    ...
    model.ArrayDataType("a5db84f2-4562-478d-9f45-2619c9d939a9", false, "9b5fd897-7dbf-4a00-8ed1-da269995e599"),
    model.SimpleDataType("2b737c59-6443-4a2a-80c3-a99709b306a6", true, "Integer"),
    model.ArrayDataType("eefa2d78-af41-41eb-ac5c-518e234cfd4c", true, "602147fa-7148-46a7-9978-ba9f63f6b616"),
    model.StructDataType(
    ...
    model.ArrayDataType("7c115a74-9fbd-49cd-b215-ad8f43ded504", true, "d64a20af-86fe-413e-baca-83b4e677e2c2"),
    model.StructDataType(
    ...
    model.ArrayDataType("5789a077-9bd1-400d-87d6-cdfde9a78500", true, "95318394-ec7b-40db-ae53-6442437e36de"),
    model.StructDataType(
    ...
    model.ArrayDataType("d41bc4c9-8f61-49ee-9b28-5fe7afb92076", true, "7c9fc3e9-30e1-4a51-918f-fdaeac32744f"),
    model.ArrayDataType("a5b9cdcb-ce52-4143-b393-5bcc8fc0fd4c", false, "a5b9cdcb-ce52-4143-b393-5bcc8fc0fd4"),
    model.ArrayDataType("926e42fc-e3ef-4520-854b-af64c089eb00", false, "d41bc4c9-8f61-49ee-9b28-5fe7afb92076"),
    model.SimpleDataType("c633cbc0-688c-4cf8-b044-5261082b7f50", true, "decimal(38,18)"),
    model.StructDataType(
    ...
    model.SimpleDataType("5d6d8b67-95cc-464c-9f7c-952b20201245", true, "double"),
    model.StructDataType(
    ...
    model.SimpleDataType("67545ab9-6fb0-4fde-b066-0675a8f7d8c5", true, "timestamp"),
    model.StructDataType(
    ...
    model.SimpleDataType("3d8b737e-7b6f-416e-b6bd-3423959121ef", false, "string"),
    model.SimpleDataType("df6acd4f-e9cd-4485-9727-6a9453373918", true, "null"),
    model.SimpleDataType("7785aba3-0a6f-44ae-b8e6-fbf02a2ff6c", false, "boolean"),
    model.SimpleDataType("839c9607-0b9f-4efe-8066-c18ca97cd3dc", false, "integer"),
    model.SimpleDataType("0096c862-e16e-4215-96b8-c58a7c1680eb", false, "date"),
    model.ArrayDataType("c18b0377-f1b5-49e1-a368-58643e35439e", false, "a5b9cdcb-ce52-4143-b393-5bcc8fc0fd4c"),
    model.SimpleDataType("7db88d2e-9903-4961-a739-de914eb3f952", true, "decimal(8,8)"),
    model.SimpleDataType("e7e4fecf-8f5e-4f57-8859-5354fa2f30ea", false, "decimal(8,8)"),
    model.SimpleDataType("d3d7add3-cd2d-41a6-9b0b-20d6b14ccccc", true, "boolean"),
    model.ArrayDataType("c18d7e59-616d-493d-b099-6f1d09f2758b", false, "a5b9cdcb-ce52-4143-b393-5bcc8fc0fd4c"),
    model.SimpleDataType("6d057a8e-d330-4b99-a366-19bf501cc1c5", false, "long")
