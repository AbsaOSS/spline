...
import za.co.absa.spline.producer.model.v1_2.{AttrOrExprRef, ExpressionLike, Literal}
import za.co.absa.spline.producer.modelmapper.v1_0.ExpressionConverter
