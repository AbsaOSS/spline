...
import org.springframework.web.servlet.mvc.method.annotation.{DeferredResultAdapter, DeferredResultMethodReturnValueHandler}

import scala.concurrent.{ExecutionContext, Future}
import scala.util.{Failure, Success}

class ScalaFutureMethodReturnValueHandler(implicit ec: ExecutionContext) extends DeferredResultMethodReturnValueHandler {
  getAdapterMap.clear()
