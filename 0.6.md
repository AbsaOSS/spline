...
-   `spline.database.logFullQueryOnError`
...
**Note**: Upgrade to version 0.6 has yet to be implemented. It should be available in the next minor release. See issue [#673](https://github.com/AbsaOSS/spline/issues/673) 
