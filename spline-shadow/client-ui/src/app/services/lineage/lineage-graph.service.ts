...
export class LineageGraphService {
  ...
  public getAttribute = (attributeId: string, dataTypes: Array<DataType>, attributeRefArray: Array<AttributeRef>, attributeName: string = null): AttributeVM => {

    let dataType = this.getDataType(dataTypes, attributeId)
