...
import za.co.absa.spline.common.webmvc.jackson.JacksonConfigSpec.DrinkStuff.{Coffee, Drink, Tea}
import za.co.absa.spline.common.webmvc.jackson.JacksonConfigSpec.ScalaStuff.{Bar, Foo}
import za.co.absa.spline.common.scalatest.MatcherImplicits
