...
import za.co.absa.spline.producer.modelmapper.v1_0.TypesV10.{AttrId, ExprDef, Schema}
import za.co.absa.spline.producer.modelmapper.v1_0.{AttributeDependencyResolver, FieldNamesV10}
...
object SparkSpline04AttributeDependencyResolver extends AttributeDependencyResolver {
  ...
  override def resolve(
    ...
    op.extra(FieldNamesV10.OperationExtraInfo.Name) match {
