...
function getExecutionEventFromEventKey(eventKey) {
...
function getTargetDataSourceFromExecutionEvent(executionEvent) {
    return db._query(aql`
...
function constructLineageOverview(executionEvent, targetDataSource, maxDepth, lineageGraph) {
    return {
        "info": {
...
function getStartDataSourceFromExecutionEvent(startEvent) {
    return db._query(aql`
        WITH progress, progressOf, executionPlan, affects, dataSource
...
function getPartialGraphForEvent(event) {
...
function eventLineageOverviewGraph(observeByEventFn, startEvent, maxDepth) {
