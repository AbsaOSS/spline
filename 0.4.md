...
-   [ClientUI](https://github.com/AbsaOSS/spline/tree/release/0.4/client-ui)

-   [Examples](https://github.com/AbsaOSS/spline-spark-agent/tree/develop/examples)
...
-   [```za.co.absa.spline:rest-gateway:{{site.version}}```](https://repo1.maven.org/maven2/za/co/absa/spline/rest-gateway/{{site.version}}/) (optional)

-   [```za.co.absa.spline:client-web:{{site.version}}```](https://repo1.maven.org/maven2/za/co/absa/spline/client-web/{{site.version}}/) (optional)
...
```shell
java -jar admin/target/admin-{{site.version}}.jar db-init arangodb://localhost/spline
```
...
Add the argument for the arango connection string\
...
To specify the consumer url please edit the [config.json](https://github.com/AbsaOSS/spline/blob/release/0.4/client-ui/src/assets/config.json) file

You can find the documentation of this module in [ClientUI](https://github.com/AbsaOSS/spline/tree/release/0.4/client-ui).
...
For more information please take a look in [migrator tool documentation](https://github.com/AbsaOSS/spline/tree/develop/migrator-tool)
