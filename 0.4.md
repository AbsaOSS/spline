...
<h2 style="color:red">This Spline version has reached the End-Of-Life and is not maintained anymore.</h2>
<h2>Please use a <a href="https://absaoss.github.io/spline/">recent Spline version</a>.</h2>
<br>
...
Other docs/readme files can be found at:
  ...
  - [Examples](https://github.com/AbsaOSS/spline/tree/release/{{page.version}}/examples)
  - [Spark Agent](https://github.com/AbsaOSS/spline/tree/release/{{page.version}}/spark/agent)
...
#### Download prebuild Spline artifacts from the Maven repo
  ...
  - [```za.co.absa.spline:spark-agent-bundle-2.2:{{page.version}}```](https://repo1.maven.org/maven2/za/co/absa/spline/spark-agent-bundle-2.2/{{page.version}}/) (For Spark 2.2)
  - [```za.co.absa.spline:spark-agent-bundle-2.3:{{page.version}}```](https://repo1.maven.org/maven2/za/co/absa/spline/spark-agent-bundle-2.3/{{page.version}}/) (For Spark 2.3)
  - [```za.co.absa.spline:spark-agent-bundle-2.4:{{page.version}}```](https://repo1.maven.org/maven2/za/co/absa/spline/spark-agent-bundle-2.4/{{page.version}}/) (For Spark 2.4)
...
```shell
java \
  -jar admin/target/admin-{{page.version}}.jar \
...
For more information please take a look in [migrator tool documentation](https://github.com/AbsaOSS/spline/tree/release/{{page.version}}/migrator-tool).
